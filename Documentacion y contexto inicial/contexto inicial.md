...
**## 4. Retenciones (valores)**

- Servicios: 75% Retencion correspondiente al IVA y 2% de Impuesto sobre la renta (ISLR), 10% Retencion Fiel Cumplimiento + 5% Retencion laboral 

- Suministros: 75%, sin ISLR, 10% Retencion Fiel Cumplimiento + 5% Retencion laboral 

**## 5. Estados de documentos**

- Presupuesto: borrador | enviado | aceptado | facturado | anulado
